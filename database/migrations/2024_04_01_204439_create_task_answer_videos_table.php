...
class CreateTaskAnswerVideosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('task_answer_videos', function (Blueprint $table) {
            $table->increments('task_answer_video_id');
    ...
    {
        Schema::dropIfExists('task_answer_videos');
    }
}
